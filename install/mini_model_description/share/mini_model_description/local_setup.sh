...
: ${AMENT_CURRENT_PREFIX:="/media/aryan-k-k/2TB_KK/CSE_Recruitment/install/mini_model_description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mini_model_description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mini_model_description/environment/path.sh"
